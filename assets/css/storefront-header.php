...
$cartCount = ($customerLoggedIn || $adminLoggedIn)
    ? sf_cart_count($pdo)
    : 0;
...
<head>
    ...
    <link href="assets/css/storefront-pages.css?v=20260810-2" rel="stylesheet">
    <style>
...
<body>
    ...
    <div class="top-strip">
        <div class="top-strip-track">
            ...
            <div class="top-strip-content" <?= $copy === 1 ? 'aria-hidden="true"' : ''; ?>>
    ...
    <header>
        <div class="container navbar">
            <a href="index.php" class="brand" aria-label="<?= sf_e($companyName); ?>">
                <div class="brand-logo">
                    <img src="<?= sf_e($logoPath); ?>" alt="<?= sf_e($companyName); ?> Logo">
                </div>
            </a>
            ...
            <div class="store-nav-actions">
                ...
                <a href="cart.php" class="quote-btn cart-link" aria-label="Open shopping cart" data-cart-open>
                ...
                <div class="store-account-menu" data-account-menu>
                    <button type="button" class="store-account-trigger" data-account-trigger aria-haspopup="true"
                        aria-expanded="false">
                ...
                <a href="cart.php" class="quote-btn cart-link" aria-label="Open administrator test cart" data-cart-open>
                    <span aria-hidden="true">🛒</span>
                    <span>Cart</span>
                ...
                <a href="admin/dashboard.php" class="quote-btn storefront-admin-button">
                    <span aria-hidden="true">⚙</span>
                    Admin Panel
                </a>

                <a href="logout.php" class="quote-btn storefront-logout-button">
                    <span aria-hidden="true">↪</span>
                    Logout
                </a>

                <?php else: ?>
                <a href="<?= sf_e($loginUrl); ?>" class="quote-btn storefront-login-button"
                    aria-label="Login to continue">
                    <span class="storefront-login-icon" aria-hidden="true">👤</span>
                ...
                <button type="button" class="mobile-menu" id="mobileMenuButton" aria-label="Open menu"
                    aria-controls="storeNavigation" aria-expanded="false">☰</button>
            </div>
        </div>
    </header>
